...
{
    public class HttpControllerHandlerHelper
    {
        ...
        internal static HttpRequestMessage ConvertRequest(HttpContextBase httpContextBase)
        {
            ...
            bool isInputBuffered = policySelector == null
                                       ? true
            ...
            request.Properties.Add(InternalConstants.HttpContextBaseKey, httpContextBase);
        ...
        private static void AddHeaderToHttpRequestMessage(HttpRequestMessage httpRequestMessage, string headerName,
                                                          string[] headerValues)
        {
        ...
        private static X509Certificate2 RetrieveClientCertificate(HttpRequestMessage request)
        {
            ...
            {
                if (httpContextBase.Request.ClientCertificate.Certificate != null &&
